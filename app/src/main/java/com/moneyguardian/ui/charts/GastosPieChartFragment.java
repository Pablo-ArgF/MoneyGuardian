...
public class GastosPieChartFragment extends AbstractChartFragment {
    ...
    public static GastosPieChartFragment newInstance(List<Gasto> param1) {
        GastosPieChartFragment fragment = new GastosPieChartFragment();
